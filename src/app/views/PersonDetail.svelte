<script lang="ts">
  ...
  import {makeFeed} from "src/domain"
   import {myLoad, calculateTrustScore, userMutedPubkeys, userFollows, follow, unfollow} from "src/engine"
  ...
  const wotScore = calculateTrustScore(pubkey)
              ...
              <div on:click|stopPropagation>
                <Popover triggerType="mouseenter" opts={{hideOnClick: true}}>
                  ...
                  <Link
                    ...
                    Kepercayaan: {Math.round(wotScore)}%
                  </Link>
                </Popover>
              </div>
            </div>
